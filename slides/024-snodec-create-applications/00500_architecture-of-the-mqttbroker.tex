...
\begin{frame}[fragile]{Ordinary \texttt{SocketServer} objects and the MQTT-Broker application}
  \begin{itemize}
    \item The MQTT broker \texttt{\alert{mqttbroker}} is an ordinary \alert{TCP server} application communicating \alert{unencrypted} via \alert{IPv4} with the MQTT broker protocol attached.
