...
\begin{frame}[fragile]{How to Create a Webserver Object}
  After including a concrete \lstinline|"express/[security]/[network]/WebApp.h"| header one can instanciate a webserver object by using the class name \lstinline|express::[security]::[network]::WebApp| and either the \textcolor{fh-ooe-red}{default constructor} or the \textcolor{fh-ooe-red}{constructor expecting} an \textcolor{fh-ooe-red}{instance name} as argument.
