\begin{frame}{Synchronization of LoRa Transceivers}
  ...
  \begin{itemize}
    ...
    \item \alert{two chirps} with a \alert{predefined modulation\footnote{\alert{LoRaWAN} uses \alert{unmodulated up-chirp} as predefined modulation.}} encoding a network number, terminated by
