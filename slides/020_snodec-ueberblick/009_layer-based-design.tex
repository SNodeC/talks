  ...
  {\centering
    \begin{figure}
      \begin{tikzpicture}
        ...
        \draw (env.north) node[anchor=south, outer sep=0, draw, fill=orange!30, minimum width=10cm, minimum height=1cm, align=center] (sc) {Network Layer\\\texttt{SocketConnection<SCF\footnote{\texttt{SCF \ldots SocketContextFactory}}>}};
...
\begin{itemize}
     \item The application protocol layer, i.e. \texttt{SocketContext} objects, can be exchanged within an existing server/client \texttt{SocketConnection}.
