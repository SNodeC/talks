...
\begin{frame}{HTTP Server and Client \texttt{SocketContext}s}{Application Protocols}
  ...
  \end{center}\begin{itemize}
     \item HTTP \alert{request parser} (fairly complete)
     \item HTTP \alert{response parser} (fairly complete)
     \item \alert{Cookie} and \alert{query} support
     \item Connection management (Connection: close, keep-alive, upgrade, ...)
     \item Real \alert{pipelining} (but will probably be thrown out again)
