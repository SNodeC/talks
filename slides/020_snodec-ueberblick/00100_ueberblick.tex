...
\def\insertlecturepartnumbername{\href{https://github.com/SNodeC/snode.c}{\Huge\alert{SNode.C}}}

\lecture[Overview]{Overview}{Overview}

\part{My Contribution to Sustainability}
\section{Motivation}

\begin{frame}{My Contribution to Sustainability}{Motivation}
   \begin{center}
