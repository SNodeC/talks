\begin{frame}[t]{Data Rate, Bit Rate and Payload Size}
  ...
  \begin{description}[$\Rightarrow$]
    ...
    \item[$\Rightarrow$] The \alert{payload size} can have a \alert{upper limit} if \alert{dwell time} is imposed by the regulator. E.g. US510 there is a dwell limit of $\SI{400}{\milli\second}$.
  \end{description}
\end{frame}
