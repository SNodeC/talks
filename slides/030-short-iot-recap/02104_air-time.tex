\begin{frame}{How Symbols get encoded - \alert{Frequency Shift} Chirp Spread Spectrum (FSCSS)}
  \begin{itemize}
    ...
    \end{description}
    \item The \alert{frequency shift} (starting step-number) represents a concrete symbol.
    \begin{description}
      \item[$\Rightarrow$] Thus a \alert{concrete frequency shift encodes one symbol}.
    \end{description}
