\subsection{Event Loop and Connection Layer}

\begin{frame}{Event Loop and Connection Layer}{Event-Based Design}
  \begin{center}
    \begin{figure}
      \par\bigskip
      \begin{tikzpicture}
...
%% End SocketConnection
      ...
      \end{tikzpicture}
      \caption{The event loop, network and connection layers more detailed.}
    \end{figure}
  \end{center}
