...
\begin{frame}[fragile]{\texttt{SocketContextFactories} of the Server and Client}
  Server
  \begin{cppcode}[autogobble=true, caption={\alert{SocketContextFactory} of the server.},captionpos=b]
  ...
  \end{cppcode}
  Client
  \begin{cppcode}[autogobble=true, caption={\alert{SocketContextFactory} of the client.},captionpos=b]
